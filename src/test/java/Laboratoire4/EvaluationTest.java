...
public class EvaluationTest {
    ...
    public void isWinning() {
        Assert.assertEquals(false, Evaluation.isPlayerWinning(board));
        Assert.assertEquals(false, Evaluation.isEnnemyWinning(board));
        ...
        Assert.assertEquals(false, Evaluation.isPlayerWinning(board));
        Assert.assertEquals(true, Evaluation.isEnnemyWinning(board));
    ...
    public void captureTest() {
        ...
        Assert.assertNotEquals("", Minmax.findBestMove(board, 3, true), 0.000000001);
    }
}